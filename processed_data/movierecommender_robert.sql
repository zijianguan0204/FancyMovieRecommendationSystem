...
load data local infile 'E:/CMPE256/data/movies_metadata_processed.csv' 
...
load data local infile 'E:/CMPE256/data/movies_genre.csv' 
...
load data local infile 'E:/CMPE256/data/rating_processed.csv' 
INTO TABLE ratings  
FIELDS TERMINATED BY ','  
ENCLOSED BY '"' 
LINES TERMINATED BY '\n' 
...
load data local infile 'E:/CMPE256/data/cast_info.csv' 
...
load data local infile 'E:/CMPE256/data/crew_info.csv' 
...
load data local infile 'E:/CMPE256/data/movie_cast.csv' 
...
load data local infile 'E:/CMPE256/data/movie_crew.csv' 
